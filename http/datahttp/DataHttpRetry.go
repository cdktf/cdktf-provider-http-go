...
type DataHttpRetry struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/http/3.4.2/docs/data-sources/http#attempts DataHttp#attempts}
	Attempts *float64 `field:"optional" json:"attempts" yaml:"attempts"`
	// The maximum delay between retry requests in milliseconds.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/http/3.4.2/docs/data-sources/http#max_delay_ms DataHttp#max_delay_ms}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/http/3.4.2/docs/data-sources/http#min_delay_ms DataHttp#min_delay_ms}
